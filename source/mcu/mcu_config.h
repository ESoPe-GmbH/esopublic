...
#define MCU_DEBUG_ENABLE								(CONFIG_MCU_DEBUG_ENABLE)
/// Enables/disables the timer used for mcu_wait functions
#define MCU_PERIPHERY_ENABLE_WAIT_TIMER					(CONFIG_MCU_PERIPHERY_ENABLE_WAIT_TIMER)
/// Enable/disable rtc functions.
#define MCU_PERIPHERY_ENABLE_RTC						(CONFIG_MCU_PERIPHERY_ENABLE_RTC)
/// Set this to enable the external quartz for RTC.
#define MCU_PERIPHERY_ENABLE_EXT_QUARTZ					(CONFIG_MCU_PERIPHERY_ENABLE_EXT_QUARTZ)
/// Enable/disable functions to write into the code flash.
#define MCU_PERIPHERY_ENABLE_CODE_FLASH					(CONFIG_MCU_PERIPHERY_ENABLE_CODE_FLASH)
/// Enable/disable functions to write into the data flash.
#define MCU_PERIPHERY_ENABLE_DATA_FLASH					(CONFIG_MCU_PERIPHERY_ENABLE_DATA_FLASH)
/// Enable/disable Watchdog functions.
#define MCU_PERIPHERY_ENABLE_WATCHDOG					(CONFIG_MCU_PERIPHERY_ENABLE_WATCHDOG)
/// Enable/disable ethernet.
#define MCU_PERIPHERY_ENABLE_ETHERNET					(CONFIG_MCU_PERIPHERY_ENABLE_ETHERNET)
/// Enable/disable wifi of mcu.
#define MCU_PERIPHERY_ENABLE_WIFI						(CONFIG_MCU_PERIPHERY_ENABLE_WIFI)
/// Enable/disable comm interface create function for the UART.
#define MCU_PERIPHERY_ENABLE_COMM_MODE_UART				(CONFIG_MCU_PERIPHERY_ENABLE_COMM_MODE_UART)
/// Enable/disable freertos
#define MCU_ENABLE_FREERTOS								(CONFIG_MCU_ENABLE_FREERTOS)
