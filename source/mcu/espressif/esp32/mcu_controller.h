...
typedef enum
{
	...
	GPIO18 = 0x0012,
	GPIO19 = 0x0013,
#if CONFIG_IDF_TARGET_ESP32S3 || CONFIG_IDF_TARGET_ESP32P4 || CONFIG_IDF_TARGET_ESP32C6
	GPIO20 = 0x0014,
#endif
	GPIO21 = 0x0015,
#if CONFIG_IDF_TARGET_ESP32 || CONFIG_IDF_TARGET_ESP32P4 || CONFIG_IDF_TARGET_ESP32C6
	GPIO22 = 0x0016,
	GPIO23 = 0x0017,
	GPIO24 = 0x0018,
	GPIO25 = 0x0019,
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	#define MCU_UART_INIT_DEBUG_PARAM		0, GPIO16, GPIO17
#else
