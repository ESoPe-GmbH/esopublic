...
#if KERNEL_USES_SLINT && DISPLAY_SLD_BOUNCE_BUFFER_PERCENTAGE < 5
    device->mcu_config.rgb.esp32.bounce_buffer_size_percent = 5;
#elif defined(DISPLAY_SLD_BOUNCE_BUFFER_PERCENTAGE) && DISPLAY_SLD_BOUNCE_BUFFER_PERCENTAGE > 0
    device->mcu_config.rgb.esp32.bounce_buffer_size_percent = DISPLAY_SLD_BOUNCE_BUFFER_PERCENTAGE;
#endif
#endif
    //[0] is 0
